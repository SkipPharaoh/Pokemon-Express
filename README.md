...
1. Refactor your app (go back and update features on your current application) with a more complicated dataset and complex UI. You can follow this [Pokedex](https://git.generalassemb.ly/wc-seir-726/seir-726-curriculum/tree/master/8_hw_and_solutions/unit_2/Pokedex) readme for guidelines. 
